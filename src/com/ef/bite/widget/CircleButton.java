...
public class CircleButton extends ImageView {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        canvas.drawCircle(centerX, centerY, outerRadius - pressedRingWidth, edgePaint);
...
//        this.pressedColor = getHighlightColor(color, PRESSED_COLOR_LIGHTUP);
        ...
        int myColor = getContext().getResources().getColor(R.color.bella_ios_like_item_blue);
        edgePaint.setColor(myColor);
