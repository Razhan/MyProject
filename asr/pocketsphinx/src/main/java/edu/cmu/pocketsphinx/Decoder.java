...
public class Decoder {
  ...
  public int setConfig(Config c) {
    return pocketsphinxJNI.Decoder_setConfig(swigCPtr, this, Config.getCPtr(c), c);
  }
  ...
  public int decodeRaw(String filename) {
    return pocketsphinxJNI.Decoder_decodeRaw(swigCPtr, this, filename);
  }
  ...
  public Prob getProb() {
    long cPtr = pocketsphinxJNI.Decoder_getProb(swigCPtr, this);
    return (cPtr == 0) ? null : new Prob(cPtr, false);
  }
